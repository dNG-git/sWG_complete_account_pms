...
function direct_output_oset_account_pms_box ()
{
	...
	$f_return = "<p class='pagehighlightborder{$direct_settings['theme_css_corners']} pageextrabg pageextracontent' style='text-align:center'>".(direct_local_get ("account_pms_quota")).": <strong>{$direct_cachedata['output_pms_counter']}</strong> ({$direct_cachedata['output_pms_quota_percentage']})</p>";
...
$f_return = ("<p class='pageborder{$direct_settings['theme_css_corners']} pageextrabg pageextracontent' style='text-align:left'>{$direct_cachedata['output_message']['text']}</p>
<table class='pagetable' style='width:100%'>
<thead><tr>
